...
class TodayListWidgetProvider : AppWidgetProvider() {
  override fun onUpdate(
    ...
    WidgetRefreshCoordinator.ensureScheduled(context, "today_list_update")
  }

  override fun onEnabled(context: Context) {
    super.onEnabled(context)
    WidgetRefreshCoordinator.ensureScheduled(context, "today_list_enabled")
  }

  override fun onReceive(context: Context, intent: Intent) {
    super.onReceive(context, intent)
    when (intent.action) {
      ACTION_REFRESH -> WidgetRefreshCoordinator.refreshAndRepair(context, "today_list_action")
      ACTION_THEME_REFRESH -> {
        updateTheme(context)
        WidgetRefreshCoordinator.ensureScheduled(context, "today_list_theme")
      }
  ...
  override fun onAppWidgetOptionsChanged(
    ...
    WidgetRefreshCoordinator.ensureScheduled(context, "today_list_options")
  }
  ...
  override fun onDeleted(
    ...
    WidgetRefreshCoordinator.cancelIfUnused(context, "today_list_deleted")
  }

  override fun onDisabled(context: Context) {
    super.onDisabled(context)
    WidgetRefreshCoordinator.cancelIfUnused(context, "today_list_disabled")
  }
