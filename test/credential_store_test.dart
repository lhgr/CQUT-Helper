...
void main() {
  group('CredentialStore', () {
    test(
      'returns encrypted password from secure storage when present',
      () async {
    ...
    test(
      'migrates legacy encrypted password into secure storage on first read',
      () async {
        SharedPreferences.setMockInitialValues({
          'encrypted_password': 'legacy-value',
        });
    ...
    test(
      'clears secure and legacy encrypted password values together',
      () async {
        SharedPreferences.setMockInitialValues({
          'encrypted_password': 'legacy-value',
        });
